...
@section('main')
    <main class="main">
        ...
        <article class="main__am-short">
            ...
            <p class="am-text">
                Naast alle professionele vaardigheden vertel ik graag nog even in het kort over wie ik nou eigenlijk
                ben. <br>Ik ben Jochem de Wit, 24 jaar oud en gepassioneerd skateboarder. Ik ben opgegroeid in
                Valkenburg (ZH), maar inmiddels woon ik in Den Haag, waar meer mogelijkheden zijn voor werk en skaten.
                Ik heb regelmatig behoefte om mijn hoofd leeg te maken en te ontspannen, dan duik ik graag de natuur in
                om te wandelen, of ga ik naar de zee en het strand.
            </p>
        </article>
    </main>
@endsection
